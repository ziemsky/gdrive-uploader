...
import com.ziemsky.gdriveuploader.test.e2e.data.TestFilesInput
import com.ziemsky.gdriveuploader.test.e2e.data.TestFixtureService
...
//        )
        ...
        `when`("app is started") {
            ...
            then("it uploads all files in batches") {
                ...
                verify(postRequestedFor(urlEqualTo("/upload/drive/v3/files")))
            }
        }
    }
})
